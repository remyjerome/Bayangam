 ...
 */
class Blog extends \wp\AssociationBundle\Entity\Blog implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'wp\\AssociationBundle\\Entity\\Blog' . "\0" . 'id', '' . "\0" . 'wp\\AssociationBundle\\Entity\\Blog' . "\0" . 'titre', '' . "\0" . 'wp\\AssociationBundle\\Entity\\Blog' . "\0" . 'auteur', '' . "\0" . 'wp\\AssociationBundle\\Entity\\Blog' . "\0" . 'article', '' . "\0" . 'wp\\AssociationBundle\\Entity\\Blog' . "\0" . 'dateAjout', '' . "\0" . 'wp\\AssociationBundle\\Entity\\Blog' . "\0" . 'dateEvenement', '' . "\0" . 'wp\\AssociationBundle\\Entity\\Blog' . "\0" . 'photo', '' . "\0" . 'wp\\AssociationBundle\\Entity\\Blog' . "\0" . 'video');
        }
