 ...
 */
class TimeLine extends \wp\AssociationBundle\Entity\TimeLine implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'wp\\AssociationBundle\\Entity\\TimeLine' . "\0" . 'id', '' . "\0" . 'wp\\AssociationBundle\\Entity\\TimeLine' . "\0" . 'annee', '' . "\0" . 'wp\\AssociationBundle\\Entity\\TimeLine' . "\0" . 'commentaire');
        }
