 ...
 */
class Auteur extends \wp\AssociationBundle\Entity\Auteur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'wp\\AssociationBundle\\Entity\\Auteur' . "\0" . 'id', '' . "\0" . 'wp\\AssociationBundle\\Entity\\Auteur' . "\0" . 'nom', '' . "\0" . 'wp\\AssociationBundle\\Entity\\Auteur' . "\0" . 'prenom');
        }
