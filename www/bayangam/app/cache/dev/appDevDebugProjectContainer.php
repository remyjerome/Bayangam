...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            'admin.articles' => 'getAdmin_ArticlesService',
            'admin.auteur' => 'getAdmin_AuteurService',
    ...
    /**
     * Gets the 'admin.articles' service.
     *
     * @return \wp\AssociationBundle\Admin\ArticlesAdmin A wp\AssociationBundle\Admin\ArticlesAdmin instance.
     */
    protected function getAdmin_ArticlesService()
    {
        $instance = new \wp\AssociationBundle\Admin\ArticlesAdmin('admin.articles', 'wp\\AssociationBundle\\Entity\\Articles', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'admin.auteur' service.
     *
     * @return \wp\AssociationBundle\Admin\AuteurAdmin A wp\AssociationBundle\Admin\AuteurAdmin instance.
     */
    protected function getAdmin_AuteurService()
    {
        $instance = new \wp\AssociationBundle\Admin\AuteurAdmin('admin.auteur', 'wp\\AssociationBundle\\Entity\\Auteur', 'SonataAdminBundle:CRUD');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/wp/AssociationBundle/Entity'), 1 => ($this->targetDirs[3].'/src/wp/UserBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'wp\\AssociationBundle\\Entity');
        $c->addDriver($b, 'wp\\UserBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('wpAssociationBundle' => 'wp\\AssociationBundle\\Entity', 'wpUserBundle' => 'wp\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_e738b95694617e4dc163ee8b650f2cc5fb7092dc348859cbf94889d1f23129fd');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('wp\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('wp\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('wp\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('wp\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'wp\\UserBundle\\Entity\\User');
    }
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'admin.articles', 1 => 'admin.auteur'));
        $instance->setAdminGroups(array('default' => array('label' => 'default', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => 'admin.articles', 1 => 'admin.auteur'))));
        $instance->setAdminClasses(array('wp\\AssociationBundle\\Entity\\Articles' => array(0 => 'admin.articles'), 'wp\\AssociationBundle\\Entity\\Auteur' => array(0 => 'admin.auteur')));
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'admin.articles', 1 => 'admin.auteur'), $this);
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/wp/AssociationBundle/Resources/views'), 'wpAssociation');
        ...
        $instance->addPath(($this->targetDirs[3].'/src/wp/UserBundle/Resources/views'), 'wpUser');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('f7a44f08da24a076f32fb8b65f6f7b6765b4e96a');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'wpAssociationBundle' => 'wp\\AssociationBundle\\wpAssociationBundle',
                'SonataCoreBundle' => 'Sonata\\CoreBundle\\SonataCoreBundle',
                'SonataBlockBundle' => 'Sonata\\BlockBundle\\SonataBlockBundle',
                'KnpMenuBundle' => 'Knp\\Bundle\\MenuBundle\\KnpMenuBundle',
                'SonataDoctrineORMAdminBundle' => 'Sonata\\DoctrineORMAdminBundle\\SonataDoctrineORMAdminBundle',
                'SonataAdminBundle' => 'Sonata\\AdminBundle\\SonataAdminBundle',
                'wpUserBundle' => 'wp\\UserBundle\\wpUserBundle',
            ...
            'secret' => 'f7a44f08da24a076f32fb8b65f6f7b6765b4e96a',
            'locale' => 'fr',
            ...
            'kernel.secret' => 'f7a44f08da24a076f32fb8b65f6f7b6765b4e96a',
            ...
            'fos_user.model.user.class' => 'wp\\UserBundle\\Entity\\User',
